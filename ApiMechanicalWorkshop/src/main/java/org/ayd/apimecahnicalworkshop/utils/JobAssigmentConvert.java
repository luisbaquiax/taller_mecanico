...
public class JobAssigmentConvert {
    ...
    public JobAssigmentDTO mapToDTO(JobAssigment jobAssigment) {
        ...
        jobAssigmentDTO.setRoleAssignment(jobAssigment.getRoleAssignment().name());
    ...
    public JobAssigment mapToEntity(JobAssigmentDTO jobAssigmentDTO) {
        ...
        jobAssigment.setRoleAssignment(JobAssigment.RoleAssignment.valueOf(jobAssigmentDTO.getRoleAssignment()));
